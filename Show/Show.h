...
#define TUBE9	GPIO_Write(GPIOA,~0X0067);	//0000 0000 0110 0111
#define CLEAR GPIO_Write(GPIOA,~0X0000);	//0000 0000 0000 0000


#define TTUBE1 GPIO_Write(GPIOA,~0X0E00);	//0000 1110 0000 0000
#define TTUBE2 GPIO_Write(GPIOA,~0X0D00);	//0000 1101 0000 0000
#define TTUBE3 GPIO_Write(GPIOA,~0X0B00);	//0000 1011 0000 0000
#define TTUBE4 GPIO_Write(GPIOA,~0X0700);	//0000 0111 0000 0000
