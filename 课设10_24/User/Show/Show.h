...
void Display();							//display 4 numbers
...
#define TTUBE1 GPIO_Write(GPIOB,0X000E);	//0000 0000 0000 1110
#define TTUBE2 GPIO_Write(GPIOB,0X000D);	//0000 0000 0000 1101
#define TTUBE3 GPIO_Write(GPIOB,0X000B);	//0000 0000 0000 1011
#define TTUBE4 GPIO_Write(GPIOB,0X0007);	//0000 0000 0000 0111
