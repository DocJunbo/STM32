...
void Display_HELP(void);			//display the word of help

void Display_SAFE(void);				
																				//0000 0000 HGFE DCBA        
...
#define TUBES	GPIO_Write(GPIOA,0X006D);	//0000 0000 0110 1101
#define TUBEA	GPIO_Write(GPIOA,0X0077);	//0000 0000 0111 0111
#define TUBEF	GPIO_Write(GPIOA,0X0071);	//0000 0000 0111 0001
